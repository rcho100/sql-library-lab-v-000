...
def select_series_title_with_most_human_characters
  # "SELECT series.title FROM series JOIN characters ON series.id = characters.series_id WHERE characters.species = 'humans' GROUP BY series.title ORDER BY COUNT(*) DESC LIMIT 1;"
  ""
end
